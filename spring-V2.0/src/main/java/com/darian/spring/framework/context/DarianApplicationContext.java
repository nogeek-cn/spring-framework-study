...
public class DarianApplicationContext implements DarianBeanFactory {
    ...
    private Map<String, DarianBeanDefinition> beanDefinitionMap = new ConcurrentHashMap<String, DarianBeanDefinition>();
...
//                    this.beanDefinitionMap.put(darianBeanDefinition.getBeanClassName(), darianBeanDefinition);
    ...
    public Object getBean(String beanName) {
        DarianBeanDefinition darianBeanDefinition = this.beanDefinitionMap.get(beanName);

        String className = darianBeanDefinition.getBeanClassName();

        try {
            // 生成通知事件，
            DarianBeanPostProcessor beanPostProcessor = new DarianBeanPostProcessor();

            Object instance = instantionBean(darianBeanDefinition);
            if (null == instance) {
                return null;
            }
